...
<div class="chart-area">
    ...
    <div id="demo-3" class="demo">
        ...
        >
            ...
            <i-bar
                :data="['79', '97', '107', '68', '62', '61', '244', '202', '207', '71', '38', '58', '109','79', '97', '107', '68', '62', '61', '244', '202', '207', '71', '38', '58', '109','79', '97', '107', '68', '62', '61', '244', '202', '207', '71', '38', '58', '109','79', '97', '107', '68', '62', '61', '244', '202', '207', '71', '38', '58', '109']"
                :itemStyle="{ normal : { color : 'rgba(116,180,255,0.4)' } }"
                :barMaxWidth="stack_width"
                :name="`宽带日受理`"
                :stack="`宽带`"
            >
            </i-bar>
            <i-bar
                :data="['178', '243', '201', '137', '163', '109', '503', '207', '533', '96', '58', '110', '151', '178', '243', '201', '137', '163', '109', '503', '207', '533', '96', '58', '110', '151']"
                :itemStyle="{ normal : { color : '#FFF' } }"
                :barMaxWidth="stack_width"
                :name="`宽带日竣工`"
                :stack="stack_name"
            ...
            <i-x-axis
                :data="['武林', '西湖', '江干', '拱墅', '下沙', '滨江', '萧山', '富阳', '余杭', '建德', '淳安', '桐庐', '临安', '武林', '西湖', '江干', '拱墅', '下沙', '滨江', '萧山', '富阳', '余杭', '建德', '淳安', '桐庐', '临安','武林', '西湖', '江干', '拱墅', '下沙', '滨江', '萧山', '富阳', '余杭', '建德', '淳安', '桐庐', '临安', '武林', '西湖', '江干', '拱墅', '下沙', '滨江', '萧山', '富阳', '余杭', '建德', '淳安', '桐庐', '临安']"
                :axisLabel="{ color: '#fff', formatter : ( value ) => value.split('').join('\n'), interval : 0 }"
                :axisLine="{ show : false }"
                :axisTick="{ show : false }"
                :splitLine="{ show : false }"
